            ...
            <aside class="hotel-search-results hotel-search-filters">
                ...
                <form name="searchForm" id="searchForm" method="get" action="index.php">
                    ...
                    <div class="date-search">
                        <div class="form-group">
                            <input type="text" id="check_in_date" name="check_in_date" placeholder="Check-In Date" value=<?=$checkInDate?>>
                        </div>
                        <div class="form-group">
                            <input type="text" id="check_out_date" name="check_out_date" placeholder="Check-Out Date" value=<?=$checkOutDate?>>
                        </div>
                    </div>
